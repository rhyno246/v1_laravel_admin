        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <div class="text-right">
                    @csrf
                    <a class="btn btn-danger d-none deleteSeleted" data-url="{{ route('tags.product.seletedeleted') }}"
                        style="color: #fff"></a>
                </div>
            </div>
            <div class="card-body">
                                ...
                                <tr id="ids{{ $item->id }}">
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            <a href="{{ route('tags.product.edit', ['id' => $item->id]) }}"
                                                class="btn btn-primary mr-2">Sửa</a>


                                            <a href="{{ route('tags.product.detele', ['id' => $item->id]) }}"
                                                class="btn btn-danger delete-model"
                                                data-url="{{ route('tags.product.detele', ['id' => $item->id]) }}">Xóa</a>
